#include "DSelector_gpi0pi0.h"

void DSelector_gpi0pi0::Init(TTree *locTree)
{
	...
	dOutputFileName = "gpi0pi0.root"; //"" for none
...
Bool_t DSelector_gpi0pi0::Process(Long64_t locEntry)
{
	...
	*/
	...
	for(UInt_t loc_i = 0; loc_i < Get_NumCombos(); ++loc_i)
	{
		...
		locMissingP4_Measured -= locPhoton1P4_Measured + locProtonP4_Measured + locPhoton2P4_Measured + locPhoton3P4_Measured + locPhoton4P4_Measured + locPhoton5P4_Measured;
...
void DSelector_gpi0pi0::Finalize(void)
{
