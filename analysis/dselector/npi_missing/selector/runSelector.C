...
void runSelector(TString runNumber = "30496", TString myPath = "/sciclone/data10/jrstevens01/RunPeriod-2017-01/analysis/ver08/tree_npi_missing/merged/") 
{
  ...
  TChain *chain = new TChain("npi_missing_Tree");
  ...
  if(files) {
	  ...
	  DPROOFLiteManager::Process_Chain(chain, "DSelector_npi_missing.C+", Proof_Nthreads, Form("hist_npi_%s.acc.root", runNumber.Data()), "", Form("tree_flat_npi_missing_%s.acc.root", runNumber.Data()), "flat_empty");
  }
