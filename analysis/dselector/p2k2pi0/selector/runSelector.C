...
void runSelector(TString runNumber = "11366", TString myPath = "/sciclone/data10/jrstevens01/RunPeriod-2016-02/analysis/ver06/tree_2pi0kmkp/") 
{
  ...
  TChain *chain = new TChain("2pi0kmkp_Tree");
  ...
  if(files) {
	  ...
	  DPROOFLiteManager::Process_Chain(chain, "DSelector_p2k2pi0.C+", Proof_Nthreads, Form("hist_p2k2pi0_%s.acc.root", runNumber.Data()));
  }
