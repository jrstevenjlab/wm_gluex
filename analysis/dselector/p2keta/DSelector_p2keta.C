#include "DSelector_p2keta.h"

void DSelector_p2keta::Init(TTree *locTree)
{
	...
	dOutputFileName = "p2keta.root"; //"" for none
	...
	std::deque<Particle_t> locPhiPIDs;
        ...
        locEtaPIDs.push_back(Eta);
        std::deque<Particle_t> locPhiEtaPIDs;
        locPhiEtaPIDs.push_back(KPlus); locPhiEtaPIDs.push_back(KMinus); locPhiEtaPIDs.push_back(Eta);
        std::deque<Particle_t> locPi0PIDs;
        locPi0PIDs.push_back(Gamma); locPi0PIDs.push_back(Gamma);
	...
	dAnalysisActions.push_back(new DHistogramAction_InvariantMass(dComboWrapper, true, 0, locPhiPIDs, 500, minPhi, maxPhi, "Phi"));
        ...
        dAnalysisActions.push_back(new DHistogramAction_InvariantMass(dComboWrapper, true, Pi0, 500, 0.1, 0.17, "Pi0"));
	...
	dAnalysisActions.push_back(new DCutAction_KinFitFOM(dComboWrapper, 0.00001));
        ...
        dAnalysisActions.push_back(new DHistogramAction_InvariantMass(dComboWrapper, true, Pi0, 500, 0.1, 0.17, "Pi0_Kin0.00001"));
        dAnalysisActions.push_back(new DCutAction_InvariantMass(dComboWrapper, true, Pi0, 0.12, 0.15));
        dAnalysisActions.push_back(new DHistogramAction_InvariantMass(dComboWrapper, true, Eta, 500, 0.45, 0.65, "Eta_Kin0.000001"));
        dAnalysisActions.push_back(new DHistogramAction_2DInvariantMass(dComboWrapper, true, 0, locPhiPIDs, locEtaPIDs, 500, minPhi, maxPhi, 500, 0.45, 0.65, "PhiEta_Kin0.00001"));

	
	dAnalysisActions.push_back(new DCutAction_InvariantMass(dComboWrapper, true, 0, locPhiPIDs, 1.01, 1.03));
        dAnalysisActions.push_back(new DCutAction_InvariantMass(dComboWrapper, true, 0, locEtaPIDs, 0.51, 0.59));
        dAnalysisActions.push_back(new DHistogramAction_InvariantMass(dComboWrapper, true, 0, locPhiEtaPIDs, 500, 1.5, 3.55, "PhhiEta_Kin0.01"));
	...
	dAnalyzeCutActions = new DHistogramAction_AnalyzeCutActions( dAnalysisActions, dComboWrapper, true, 0, locPhiPIDs, 500, minPhi, maxPhi, "CutActionEffect" );
        dAnalyzeCutActionsEta = new DHistogramAction_AnalyzeCutActions( dAnalysisActions, dComboWrapper, true, 0, locEtaPIDs, 500, 0.45, 0.65, "CutActionEffectEta" );
        dAnalyzeCutActionsPi0 = new DHistogramAction_AnalyzeCutActions( dAnalysisActions, dComboWrapper, true, 2, locPi0PIDs, 500, 0.10, 0.17, "CutActionEffectPi0" );

	//INITIALIZE ACTIONS
	//If you create any actions that you want to run manually (i.e. don't add to dAnalysisActions), be sure to initialize them here as well
	Initialize_Actions();
	dAnalyzeCutActions->Initialize(); // manual action, must call Initialize()
   	dAnalyzeCutActionsPi0->Initialize();
...
Bool_t DSelector_p2keta::Process(Long64_t locEntry)
{
	...
	dAnalyzeCutActionsEta->Reset_NewEvent();
        dAnalyzeCutActionsPi0->Reset_NewEvent();
	...
	*/
	...
	for(UInt_t loc_i = 0; loc_i < Get_NumCombos(); ++loc_i)
	{
		...
		locMissingP4_Measured -= locKPlusP4_Measured + locKMinusP4_Measured + locProtonP4_Measured + locPiPlusP4_Measured + locPiMinusP4_Measured + locPhoton1P4_Measured + locPhoton2P4_Measured;
		...
		dAnalyzeCutActionsEta->Perform_Action();
                dAnalyzeCutActionsPi0->Perform_Action();
...
void DSelector_p2keta::Finalize(void)
{
