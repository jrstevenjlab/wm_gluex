...
void runSelector(TString runNumber = "307", TString myPath = "/sciclone/gluex10/RunPeriod-2017-01/analysis/ver27/tree_kpkmeta__eta_pi0pippim__B3_M17/merged/")
{
  ...
  TChain *chain = new TChain("kpkmeta__eta_pi0pippim__B3_M17_Tree");
  ...
  if(files) {
	  ...
	  DPROOFLiteManager::Process_Chain(chain, "DSelector_p2keta.C+", Proof_Nthreads, Form("hist_p2keta_%s.acc.root", runNumber.Data())); 
  }
