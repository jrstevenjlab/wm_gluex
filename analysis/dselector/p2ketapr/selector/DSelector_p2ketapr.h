#ifndef DSelector_p2ketapr_h
#define DSelector_p2ketapr_h
...
class DSelector_p2ketapr : public DSelector
{
	public:

		DSelector_p2ketapr(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_p2ketapr(){}
	...
	private:
		...
		DHistogramAction_AnalyzeCutActions* dAnalyzeCutActions, *dAnalyzeCutActionsEta, *dAnalyzeCutActionsEtaPrime;
	...
	ClassDef(DSelector_p2ketapr, 0);
};

void DSelector_p2ketapr::Get_ComboWrappers(void)
{
	//Step 0
