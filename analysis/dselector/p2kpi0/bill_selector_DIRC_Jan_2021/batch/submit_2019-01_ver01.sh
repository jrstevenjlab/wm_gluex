...
MyEnv=/sciclone/home20/wli08/myBuilds
#MyCodeDir=$WM_GLUEX/analysis/$MyProcess/
MyCodeDir=/sciclone/home20/wli08/bill_analysis/2kpi0_dirc/
...
#MyDataInDir=/sciclone/gluex10/RunPeriod-2019-11/analysis/ver01_pass00/tree_pi0kpkm__B4_M7/merged/
MyDataInDir=/sciclone/gluex10/RunPeriod-2019-11/analysis/ver01/tree_pi0kpkm__B4_M7/merged/

#MyDataOutDir=/sciclone/gluex10/$USER/data_analyzed/$MyProcess/2018-01_ver03/
MyDataOutDir=/sciclone/gluex10/$USER/data_analyzed/$MyProcess/2019-11_ver01/
