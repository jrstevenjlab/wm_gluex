...
void runSelector(TString runNumber = "11366", TString myPath = "/sciclone/data10/jrstevens01/RunPeriod-2016-02/analysis/ver05/tree_pi02pim2pip/") 
{
  ...
  if(files) {
	  ...
	  DPROOFLiteManager::Process_Chain(chain, "DSelector_pomega2pi_omega3pi.C+", Form("hist_pomega2pi_omega3pi_%s.acc.root", runNumber.Data()), Proof_Nthreads);
  }
