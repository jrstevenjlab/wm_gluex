...
gen_omegapi -c gen_omegapi_amplitude_refl+_DeltaLowerVertex_b1.cfg -o anglesOmegaPiAmplitude_refl+.root -l 1.165 -u 1.3 -n 10000 -tmin 0.1 -tmax 0.3 
...
fit -c fit_omegapi_amplitude_refl+_DeltaLowerVertex_b1_loop.cfg
...
cp anglesOmegaPiAmplitude_refl+.root anglesOmegaPiAmplitude.root
fit -c fit_omegapi_amplitude_DeltaLowerVertex_b1_loop.cfg
omegapi_plotter omegapi.fit
