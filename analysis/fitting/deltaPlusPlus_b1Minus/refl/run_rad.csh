...
gen_vec_ps -c gen_omegapi_amplitude_refl+_DeltaLowerVertex_b1_rad.cfg\
 ...
 -l 1.165 -u 1.3 -n 10000 -tmin 0.1 -tmax 0.3 
...
fit -c fit_omegapi_amplitude_refl+_DeltaLowerVertex_b1_loop_rad.cfg #-r 50
...
cp anglesOmegaPiAmplitude_refl+_rad.root anglesOmegaPiAmplitude.root
fit -c fit_omegapi_amplitude_DeltaLowerVertex_b1_loop_rad.cfg #-r 50
vecps_plotter omegapi.fit
