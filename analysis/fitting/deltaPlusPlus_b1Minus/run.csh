...
gen_omegapi -c gen_omegapi_amplitude_DeltaLowerVertex_b1.cfg -o anglesOmegaPiAmplitude.root -l 1.165 -u 1.3 -n 10000
mv gen_omegapi_diagnostic.root gen_omegapiAmplitude_b1_diagnostic.root

gen_omegapi -c gen_omegapi_amplitude_DeltaLowerVertex_b1.cfg -o anglesOmegaPiPhaseSpace.root -l 1.165 -u 1.3 -f -n 100000
