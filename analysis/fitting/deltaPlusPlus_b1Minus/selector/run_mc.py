...
def launch_period(MyRunPeriod, MyRunNumber, MyFlag, MyThrownPhasespace):
	...
	subprocess.call(["root.exe", "-l", "-b", "-q", 'runSelector.C("%02d","/sciclone/gluex10/gluex_simulations/REQUESTED_MC/omegapi_deltaPlusPlus_b1_refl-_%s/tree_pi0pippippimpim__B4_M7/merged/","%s")' % (MyRunNumber, MyRunPeriod, MyFlag)])   
	...
	#subprocess.call(["root.exe", "-l", "-b", "-q", 'runSelector.C("%02d","/sciclone/gluex10/gluex_simulations/REQUESTED_MC/omegapi_deltaPlusPlus_phasespace_%s/tree_pi0pippippimpim__B4_M7/merged/","%s phasespace")' % (MyRunNumber, MyRunPeriod, MyFlag)])
	...
	if MyThrownPhasespace:
		subprocess.call(["root.exe", "-l", "-b", "-q", 'runSelector.C("%02d","/sciclone/gluex10/gluex_simulations/REQUESTED_MC/omegapi_deltaPlusPlus_phasespace_%s/tree_thrown/merged/","thrown")' % (MyRunNumber, MyRunPeriod)])
