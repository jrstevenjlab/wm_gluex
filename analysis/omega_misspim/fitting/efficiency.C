void efficiency(const char *whichcut = "pv", bool print = false, bool save = false){
  ...
  TFile *fgen = TFile::Open(Form("mmop_gen_%scut.root", whichcut));

  TFile *fdata_m2 = TFile::Open(Form("method2_data_%scut.root", whichcut));
  TFile *fgen_m2 = TFile::Open(Form("method2_gen_%scut.root", whichcut));

  if(save == true)
    TFile *outROOT = new TFile(Form("piminus_efficiency_%scut.root", whichcut), "recreate");
  ...
  */
  ...
  c3->Print("plots/PiMinus_Efficiency.C");
  ...
  */
  ...
  //cgrid->Print("plots/PiMinus_PostageStamp.pdf");
  */
  /*
  ...
  */
  ...
  //c5->Print("plots/PiMinus_Ratio_Int.pdf");
  */
  ...
  */
  ...
  //c2D->Print("plots/PiMinusEff_Absolute.pdf");
  ...
  gPad->SetRightMargin(0.2);
  locHist_thetap_ratio_2D_m2[0]->Draw("colz text");
    //cm1->Print("plots/PiMinusEff_Ratio_m1.pdf");
    //cm2->Print("plots/PiMinusEff_Ratio_m2.pdf");
