...
void runSelector(TString runNumber = "11366", TString myPath = "/sciclone/data10/jrstevens01/RunPeriod-2016-02/analysis/ver05/tree_pimpipkmkp/") 
{
  ...
  TChain *chain = new TChain("pimpipkmkp_Tree");
  ...
  if(files) {
	  ...
	  DPROOFLiteManager::Process_Chain(chain, "DSelector_p2k2pi.C+", Proof_Nthreads, Form("hist_p2k2pi_%s.acc.root", runNumber.Data()));
  }
