...
#	sh submit_2018-01_ver03_sim_test.sh ${opt1[$i]}
	sh submit_2018-01_ver03_sim_test_long.sh ${opt1[$i]}
...
#     sh submit_2018-01_ver03_sim_test.sh ${opt1[$arrayindex]}
     sh submit_2018-01_ver03_sim_test_long.sh ${opt1[$arrayindex]}

#     sh MC_setup.sh ${opt1[$arrayindex]}
