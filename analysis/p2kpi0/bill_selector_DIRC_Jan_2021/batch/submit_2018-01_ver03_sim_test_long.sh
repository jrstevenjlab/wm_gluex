...
MyDataInDir="/sciclone/gluex10/wli08/sim_output/2kpi0_simulation_long_output/MC_2kpi0_$resonance/root/trees/"

#MyDataOutDir=/sciclone/gluex10/$USER/$MyProcess/2018-01_ver03/
MyDataOutDir=/sciclone/gluex10/$USER/sim_analyzed/$MyProcess_long/2018-01_ver03/$resonance
