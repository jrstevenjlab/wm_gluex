...
void runSelector(TString runNumber = "11366", TString myPath = "/sciclone/data10/jrstevens01/RunPeriod-2016-02/analysis/ver06/tree_pipkskm/") 
{
  ...
  TChain *chain = new TChain("pipkskm_Tree");
