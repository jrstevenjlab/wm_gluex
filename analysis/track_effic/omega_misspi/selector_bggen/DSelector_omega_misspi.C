#include "DSelector_omega_misspi.h"

void DSelector_omega_misspi::Init(TTree *locTree)
{
	...
	dOutputFileName = "omega_misspi.root"; //"" for none
...
Bool_t DSelector_omega_misspi::Process(Long64_t locEntry)
{
  ...
  // skip omega -> pi+pi-pi0 from bggen events
  ...
  */
  ...
  for(UInt_t loc_i = 0; loc_i < Get_NumCombos(); ++loc_i)
	...
	continue; // Combo has been cut previously
      ...
      Int_t locPiRecoTrackID = dPiRecoWrapper->Get_TrackID();
      ...
      TLorentzVector locPiRecoP4 = dPiRecoWrapper->Get_P4();
      TLorentzVector locProtonP4 = dProtonWrapper->Get_P4();
      TLorentzVector locMissingPiMissP4 = dMissingPiMissWrapper->Get_P4();
      //Step 1
      ...
      TLorentzVector locPiRecoP4_Measured = dPiRecoWrapper->Get_P4_Measured();
	...
	locAccid = true;
      ...
      locMissingP4_Measured -= locPiRecoP4_Measured + locProtonP4_Measured + locPhoton1P4_Measured + locPhoton2P4_Measured;
      ...
      double locPiMissPhi_mmop = locMissingP4_Measured.Phi() * 180./TMath::Pi();
      double locPiMissTheta_mmop = locMissingP4_Measured.Theta() * 180./TMath::Pi();
      TVector3 locPiMissP3_mmop = locMissingP4_Measured.Vect();
      double locPiMissP_mmop = locPiMissP3_mmop.Mag();
      ...
      for(UInt_t loc_i = 0; loc_i < Get_NumChargedHypos(); ++loc_i)
	{
	  ...
	  if (dChargedHypoWrapper->Get_PID() != PiMissID)
	    continue;
	  if (dChargedHypoWrapper->Get_TrackID() == locPiRecoTrackID)
	    continue;
	  if (dChargedHypoWrapper->Get_TrackID() == locProtonTrackID)
	    continue;
		   

	  TLorentzVector locPiMissP4_reco = dChargedHypoWrapper->Get_P4_Measured();
	  TLorentzVector loc3PiP4_reco = locPiRecoP4 + locPhoton1P4 + locPhoton2P4 + locPiMissP4_reco;
	  ...
	  locUsedThisCombo_MassCorrelation01[PiMissID].insert(dChargedHypoWrapper->Get_TrackID());
	  ...
	  locUsedThisCombo_MassCorrelation01[PiRecoID].insert(locPiRecoTrackID);
      ...
      for(UInt_t loc_i = 0; loc_i < Get_NumChargedHypos(); ++loc_i)
	{
	  ...
	  locUsedThisCombo_MassCorrelation02[PiMissID].insert(dChargedHypoWrapper->Get_TrackID());
	  ...
	  locUsedThisCombo_MassCorrelation02[PiRecoID].insert(locPiRecoTrackID);
      ...
      for(UInt_t loc_i = 0; loc_i < Get_NumChargedHypos(); ++loc_i)
	{
	  ...
	  locUsedThisCombo_MassCorrelation03[PiMissID].insert(dChargedHypoWrapper->Get_TrackID());
	  ...
	  locUsedThisCombo_MassCorrelation03[PiRecoID].insert(locPiRecoTrackID);
     ...
     double locMissingMass = locMissingP4_Measured.M();
      ...
      locUsedThisCombo_MissingMass[PiRecoID].insert(locPiRecoTrackID);
      ...
      for(UInt_t loc_i = 0; loc_i < Get_NumChargedHypos(); ++loc_i)
	{
	  ...
	  locUsedThisCombo_MassCorrelation04[PiMissID].insert(dChargedHypoWrapper->Get_TrackID());
	  ...
	  locUsedThisCombo_MassCorrelation04[PiRecoID].insert(locPiRecoTrackID);
      ...
      for(UInt_t loc_i = 0; loc_i < Get_NumChargedHypos(); ++loc_i)
	{
	  ...
	  locUsedThisCombo_MassCorrelation05[PiMissID].insert(dChargedHypoWrapper->Get_TrackID());
	  ...
	  locUsedThisCombo_MassCorrelation05[PiRecoID].insert(locPiRecoTrackID);
      ...
      for(UInt_t loc_i = 0; loc_i < Get_NumThrown(); ++loc_i)
	{
	  ...
	  if (dThrownWrapper->Get_PID() != PiMissID)
	    continue;
      ...
      for(UInt_t loc_i = 0; loc_i < Get_NumChargedHypos(); ++loc_i)
	{
	  ...
	  TLorentzVector locPiMissP4_reco = dChargedHypoWrapper->Get_P4_Measured();
	  double locPiMissPhi_reco = locPiMissP4_reco.Phi() * 180./TMath::Pi();
	  double locPiMissTheta_reco = locPiMissP4_reco.Theta() * 180./TMath::Pi();
	  TVector3 locPiMissP3_reco = locPiMissP4_reco.Vect();
	  double locPiMissP_reco = locPiMissP3_reco.Mag();
	  ...
	  locUsedThisCombo_MassCorrelation06[PiMissID].insert(dChargedHypoWrapper->Get_TrackID());
	  ...
	  locUsedThisCombo_MassCorrelation06[PiRecoID].insert(locPiRecoTrackID);
	  ...
	  if(locPiMissPhi_reco - locTruthPhi > 180.)
	    locDeltaPhiTruth = locPiMissPhi_reco - locTruthPhi - 2.0*180.;
	  else if(locPiMissPhi_reco - locTruthPhi < -180.)
	    locDeltaPhiTruth = locPiMissPhi_reco - locTruthPhi + 2.0*180.;
	  else 
	    locDeltaPhiTruth = locPiMissPhi_reco - locTruthPhi;
	  double locDeltaThetaTruth = locPiMissTheta_reco - locTruthTheta;
	  double locDeltaPTruth = locPiMissP_reco - locTruthP;
	  
	  double locDeltaPhiMissing;
	  if(locPiMissPhi_reco - locPiMissPhi_mmop > 180.)
	    locDeltaPhiMissing = locPiMissPhi_reco - locPiMissPhi_mmop - 2.0*180.;
	  else if(locPiMissPhi_reco - locPiMissPhi_mmop < -180.)
	    locDeltaPhiMissing = locPiMissPhi_reco - locPiMissPhi_mmop + 2.0*180.;
	  else
	    locDeltaPhiMissing = locPiMissPhi_reco - locPiMissPhi_mmop;
	  double locDeltaThetaMissing = locPiMissTheta_reco - locPiMissTheta_mmop;
	  double locDeltaPMissing = locPiMissP_reco - locPiMissP_mmop;

	  //Histogram DeltaPhi, DeltaTheta, DeltaP (Truth)
	  map<Particle_t, set<Int_t> > locUsedThisCombo_DeltaTruth;
	  locUsedThisCombo_DeltaTruth[PiRecoID].insert(locPiRecoTrackID);
	  ...
	  locUsedThisCombo_DeltaMissing[PiMissID].insert(dChargedHypoWrapper->Get_TrackID());
	  locUsedThisCombo_DeltaMissing[PiRecoID].insert(locPiRecoTrackID);
	  ...
	  locUsedThisCombo_MassCorrelation07[PiMissID].insert(dChargedHypoWrapper->Get_TrackID());
	  ...
	  locUsedThisCombo_MassCorrelation07[PiRecoID].insert(locPiRecoTrackID);
	  ...
	  locUsedThisCombo_MassCorrelation08[PiMissID].insert(dChargedHypoWrapper->Get_TrackID());
	  ...
	  locUsedThisCombo_MassCorrelation08[PiRecoID].insert(locPiRecoTrackID);
	  ...
	  locMissingP4_reco -= locPiRecoP4_Measured + locProtonP4_Measured + locPhoton1P4_Measured + locPhoton2P4_Measured + locPiMissP4_reco;
	  ...
	  locUsedThisCombo_MissingMassSquared[PiRecoID].insert(locPiRecoTrackID);
	  ...
	  locUsedThisCombo_MassCorrelation09[PiMissID].insert(dChargedHypoWrapper->Get_TrackID());
	  ...
	  locUsedThisCombo_MassCorrelation09[PiRecoID].insert(locPiRecoTrackID);
	  ...
	  locUsedThisCombo_MissingEnergy[PiRecoID].insert(locPiRecoTrackID);
	  ...
	  locUsedThisCombo_MassCorrelation10[PiMissID].insert(dChargedHypoWrapper->Get_TrackID());
	  ...
	  locUsedThisCombo_MassCorrelation10[PiRecoID].insert(locPiRecoTrackID);
	  ...
	  if(locUsedSoFar_MassCorrelation10.find(locUsedThisCombo_MassCorrelation10) == locUsedSoFar_MassCorrelation10.end())
	    {
	      ...
	      dHist_ThetaVsP_reco->Fill(locPiMissTheta_reco, locPiMissP_reco, locAccWeight * locPi0Weight * locTruthWeight * locCutWeight);
	  ...
	  locUsedThisCombo_OmegaMassVsPhi_1track[PiMissID].insert(dChargedHypoWrapper->Get_TrackID());
	  locUsedThisCombo_OmegaMassVsPhi_1track[PiRecoID].insert(locPiRecoTrackID);
	  ...
	  if(locUsedSoFar_OmegaMassVsPhi_1track.find(locUsedThisCombo_OmegaMassVsPhi_1track) == locUsedSoFar_OmegaMassVsPhi_1track.end())
	    {
	      dHist_OmegaMassVsPhi_1track->Fill(locOmegaMass_mmop, locPiMissPhi_mmop, locAccWeight * locPi0Weight * locTruthWeight * locCutWeight);
	      dHist_3PiMassVsPhi->Fill(loc3PiMass_reco, locPiMissPhi_mmop, locAccWeight * locPi0Weight * locTruthWeight * locCutWeight);
	      if(locPiMissP_mmop > 0.5){
		dHist_OmegaMassVsTheta_1track->Fill(locOmegaMass_mmop, locPiMissTheta_mmop, locAccWeight * locPi0Weight * locTruthWeight * locCutWeight);
		dHist_3PiMassVsTheta->Fill(loc3PiMass_reco, locPiMissTheta_mmop, locAccWeight * locPi0Weight * locTruthWeight * locCutWeight);
	      }
	      if(locPiMissTheta_mmop > 1.15){
		dHist_OmegaMassVsP_1track->Fill(locOmegaMass_mmop, locPiMissP_mmop, locAccWeight * locPi0Weight * locTruthWeight * locCutWeight);
		dHist_3PiMassVsP->Fill(loc3PiMass_reco, locPiMissP_mmop, locAccWeight * locPi0Weight * locTruthWeight * locCutWeight);
	      }
	      for(int i = 0; i < 9; i++) {
		if(locPiMissP_mmop > pmin[i] && locPiMissP_mmop < pmax[i]){
		  dHist_OmegaMassVsTheta_1track_p[i]->Fill(locOmegaMass_mmop, locPiMissTheta_mmop, locAccWeight * locPi0Weight * locTruthWeight * locCutWeight);
		  dHist_3PiMassVsTheta_p[i]->Fill(loc3PiMass_reco, locPiMissTheta_mmop, locAccWeight * locPi0Weight * locTruthWeight * locCutWeight);
		}
	      }
	  ...
	  dHist_PValueVsTheta->Fill(locPVal, locPiMissTheta_mmop);
	  ...
	  for(int i = 0; i < 7; i++){
	    if(locPVal < locPValCut[i])
	      continue;
	    locUsedThisCombo_PValueCuts[i][PiMissID].insert(dChargedHypoWrapper->Get_TrackID());
	    locUsedThisCombo_PValueCuts[i][Unknown].insert(locBeamID);
	    locUsedThisCombo_PValueCuts[i][Proton].insert(locProtonTrackID);
	    locUsedThisCombo_PValueCuts[i][PiRecoID].insert(locPiRecoTrackID);
	    ...
	    if(locUsedSoFar_PValueCuts[i].find(locUsedThisCombo_PValueCuts[i]) == locUsedSoFar_PValueCuts[i].end()){
	      ...
	      dHist_OmegaMassVsPhi_1track_pvcut[i]->Fill(locOmegaMass_mmop, locPiMissPhi_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
	      dHist_3PiMassVsPhi_pvcut[i]->Fill(loc3PiMass_reco, locPiMissPhi_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
	      dHist_Theta_recoVstruth_pvcut[i]->Fill(locPiMissTheta_reco, locTruthTheta, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
	      if(locPiMissP_mmop > 0.5){
		dHist_OmegaMassVsTheta_1track_pvcut[i]->Fill(locOmegaMass_mmop, locPiMissTheta_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
		dHist_3PiMassVsTheta_pvcut[i]->Fill(loc3PiMass_reco, locPiMissTheta_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
	      }
	      if(locPiMissTheta_mmop > 1.15){
		dHist_OmegaMassVsP_1track_pvcut[i]->Fill(locOmegaMass_mmop, locPiMissP_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
		dHist_3PiMassVsP_pvcut[i]->Fill(loc3PiMass_reco, locPiMissP_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
	      }
	      for(int ip = 0; ip < 9; ip++){
		if(locPiMissP_mmop > pmin[ip] && locPiMissP_mmop < pmax[ip]){
		  dHist_OmegaMassVsTheta_1track_pvcut_p[ip][i]->Fill(locOmegaMass_mmop, locPiMissTheta_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
		  dHist_3PiMassVsTheta_pvcut_p[ip][i]->Fill(loc3PiMass_reco, locPiMissTheta_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
		}
	      }
	  ...
	  for(int i = 0; i < 7; i++){
	    if(locPiMissTheta_reco < locthetaCut[i])
	      continue;
	    locUsedThisCombo_thetaCuts[i][PiMissID].insert(dChargedHypoWrapper->Get_TrackID());
	    locUsedThisCombo_thetaCuts[i][Unknown].insert(locBeamID);
	    locUsedThisCombo_thetaCuts[i][Proton].insert(locProtonTrackID);
	    locUsedThisCombo_thetaCuts[i][PiRecoID].insert(locPiRecoTrackID);
	    ...
	    if(locUsedSoFar_thetaCuts[i].find(locUsedThisCombo_thetaCuts[i]) == locUsedSoFar_thetaCuts[i].end()){
	      ...
	      dHist_OmegaMassVsPhi_1track_thetacut[i]->Fill(locOmegaMass_mmop, locPiMissPhi_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
	      dHist_3PiMassVsPhi_thetacut[i]->Fill(loc3PiMass_reco, locPiMissPhi_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
	      dHist_Theta_recoVstruth_thetacut[i]->Fill(locPiMissTheta_reco, locTruthTheta, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
	      if(locPiMissP_mmop > 0.5){
		dHist_OmegaMassVsTheta_1track_thetacut[i]->Fill(locOmegaMass_mmop, locPiMissTheta_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
		dHist_3PiMassVsTheta_thetacut[i]->Fill(loc3PiMass_reco, locPiMissTheta_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
	      }
	      if(locPiMissTheta_mmop > 1.15){
		dHist_OmegaMassVsP_1track_thetacut[i]->Fill(locOmegaMass_mmop, locPiMissP_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
		dHist_3PiMassVsP_thetacut[i]->Fill(loc3PiMass_reco, locPiMissP_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
	      }
	      for(int ip = 0; ip < 9; ip++){
		if(locPiMissP_mmop > pmin[ip] && locPiMissP_mmop < pmax[ip]){
		  dHist_OmegaMassVsTheta_1track_thetacut_p[ip][i]->Fill(locOmegaMass_mmop, locPiMissTheta_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
		  dHist_3PiMassVsTheta_thetacut_p[ip][i]->Fill(loc3PiMass_reco, locPiMissTheta_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
		}
	      }
	  ...
	  for(int i = 0; i < 7; i++){
	    if(locPiMissP_reco < locpCut[i])
	      continue;
	    locUsedThisCombo_pCuts[i][PiMissID].insert(dChargedHypoWrapper->Get_TrackID());
	    locUsedThisCombo_pCuts[i][Unknown].insert(locBeamID);
	    locUsedThisCombo_pCuts[i][Proton].insert(locProtonTrackID);
	    locUsedThisCombo_pCuts[i][PiRecoID].insert(locPiRecoTrackID);
	    ...
	    if(locUsedSoFar_pCuts[i].find(locUsedThisCombo_pCuts[i]) == locUsedSoFar_pCuts[i].end()){
	      ...
	      dHist_OmegaMassVsPhi_1track_pcut[i]->Fill(locOmegaMass_mmop, locPiMissPhi_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
	      dHist_3PiMassVsPhi_pcut[i]->Fill(loc3PiMass_reco, locPiMissPhi_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
	      dHist_Theta_recoVstruth_pcut[i]->Fill(locPiMissTheta_reco, locTruthTheta, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
	      if(locPiMissP_mmop > 0.5){
		dHist_OmegaMassVsTheta_1track_pcut[i]->Fill(locOmegaMass_mmop, locPiMissTheta_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
		dHist_3PiMassVsTheta_pcut[i]->Fill(loc3PiMass_reco, locPiMissTheta_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
	      }
	      if(locPiMissTheta_mmop > 1.15){
		dHist_OmegaMassVsP_1track_pcut[i]->Fill(locOmegaMass_mmop, locPiMissP_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
		dHist_3PiMassVsP_pcut[i]->Fill(loc3PiMass_reco, locPiMissP_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
	      }
	      for(int ip = 0; ip < 9; ip++){
		if(locPiMissP_mmop > pmin[ip] && locPiMissP_mmop < pmax[ip]){
		  dHist_OmegaMassVsTheta_1track_pcut_p[ip][i]->Fill(locOmegaMass_mmop, locPiMissTheta_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
		  dHist_3PiMassVsTheta_pcut_p[ip][i]->Fill(loc3PiMass_reco, locPiMissTheta_mmop, locAccWeight * locPi0Weight * locCutWeight * locTruthWeight);
		}
	      }
	  ...
	  locUsedThisCombo_Delta3D_truth[PiRecoID].insert(locPiRecoTrackID);
	  ...
	  locUsedThisCombo_Delta3D_miss[PiRecoID].insert(locPiRecoTrackID);
	  ...
	  if(locUsedSoFar_Delta3D_miss.find(locUsedThisCombo_Delta3D_miss) == locUsedSoFar_Delta3D_miss.end())
	    {
	      dHist_DeltaPhi3D_miss->Fill(locDeltaPhiMissing, locPiMissTheta_mmop, locPiMissP_mmop, locAccWeight * locPi0Weight);
	      dHist_DeltaTheta3D_miss->Fill(locDeltaThetaMissing, locPiMissTheta_mmop, locPiMissP_mmop, locAccWeight * locPi0Weight);
	      dHist_DeltaP3D_miss->Fill(locDeltaPMissing, locPiMissTheta_mmop, locPiMissP_mmop, locAccWeight * locPi0Weight);
      ...
      if(locUsedSoFar_OmegaMass.find(locUsedThisCombo_OmegaMass) == locUsedSoFar_OmegaMass.end())
	{
      ...
      locUsedThisCombo_OmegaMassVsPhi_0track[PiRecoID].insert(locPiRecoTrackID);
      ...
      if(locUsedSoFar_OmegaMassVsPhi_0track.find(locUsedThisCombo_OmegaMassVsPhi_0track) == locUsedSoFar_OmegaMassVsPhi_0track.end())
	{
	  ...
	  dHist_OmegaMassVsPhi_0track->Fill(locOmegaMass_mmop, locPiMissPhi_mmop, locAccWeight * locPi0Weight);
	  if(locPiMissP_mmop > 0.5) {
	    dHist_OmegaMassVsTheta_0track->Fill(locOmegaMass_mmop, locPiMissTheta_mmop, locAccWeight * locPi0Weight);
	  }
	  if(locPiMissTheta_mmop > 1.15) {
	    dHist_OmegaMassVsP_0track->Fill(locOmegaMass_mmop, locPiMissP_mmop, locAccWeight * locPi0Weight);
	  }
	  dHist_ThetaVsP_missing->Fill(locPiMissTheta_mmop, locPiMissP_mmop, locAccWeight * locPi0Weight);
	  for(int i = 0; i < 9; i++) {
	    if(locPiMissP_mmop > pmin[i] && locPiMissP_mmop < pmax[i]){
	      dHist_OmegaMassVsTheta_0track_p[i]->Fill(locOmegaMass_mmop, locPiMissTheta_mmop, locAccWeight * locPi0Weight);
	    }
	  }
...
void DSelector_omega_misspi::Finalize(void)
{
