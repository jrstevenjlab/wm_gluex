void efficiency(const char *whichcut = "pv", bool print = false, bool save = false){
  TFile *fdata = TFile::Open(Form("mmop_data_2018_01_%scut.root", whichcut));
  TFile *fgen = TFile::Open(Form("mmop_gen_2018_01_%scut.root", whichcut));

  TFile *fdata_m2 = TFile::Open(Form("method2_data_2018_01_%scut.root", whichcut));
  TFile *fgen_m2 = TFile::Open(Form("method2_gen_2018_01_%scut.root", whichcut));

  if(save == true)
    TFile *outROOT = new TFile(Form("piminus_efficiency_2018_01_%scut.root", whichcut), "recreate");
  ...
  ccuts->Print("plots/PiMinus_ThetaEff_PValue_cuts.pdf");
  */
  /*
  ...
  */
  ...
  ccuts_p->Print("plots/PiMinus_pEff_PValue_cuts.pdf");
  */
  /*
  ...
  */
  ...
  c3->Print("plots_2018_01/PiMinus_Efficiency.C");
  ...
  */
  ...
  cgrid->Print("plots_2018_01/PiMinus_PostageStamp.pdf");
  ...
  //if(print == true)
    //c4->Print("plots/PiMinusEfficiency.pdf");
  ...
  */
  ...
  c5->Print("plots_2018_01/PiMinus_Ratio_Int.pdf");
  ...
  */
  ...
  c2D->Print("plots_2018_01/PiMinusEff_Absolute.pdf");
  ...
  gPad->SetRightMargin(0.2);
  locHist_thetap_ratio_2D_m2[0]->Draw("colz text");
    cm1->Print("plots_2018_01/PiMinusEff_Ratio_m1.pdf");
    cm2->Print("plots_2018_01/PiMinusEff_Ratio_m2.pdf");
