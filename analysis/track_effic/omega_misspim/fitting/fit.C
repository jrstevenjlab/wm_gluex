...
void fit(bool mc = true, bool save = true, const char *whichcut = "pv", TString datadir = "/sciclone/gluex10/amschertz/omega_misspim/test7_full/", TString mcdir = "/sciclone/gluex10/amschertz/omega_misspim/geant4/test2/") {
  TFile* fhist;
  TFile* outROOT;
  ...
  if(mc == false) {
    ...
    if(save == true)
      outROOT = new TFile(Form("mmop_gen_%scut.root", whichcut), "recreate");
  }
