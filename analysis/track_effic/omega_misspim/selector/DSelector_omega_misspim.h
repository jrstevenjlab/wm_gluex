#ifndef DSelector_omega_misspim_h
#define DSelector_omega_misspim_h
...
class DSelector_omega_misspim : public DSelector
{
	public:

		DSelector_omega_misspim(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_omega_misspim(){}
	...
	private:
		...
		DKinematicData* dMissingPiMinusWrapper;
...
void DSelector_omega_misspim::Get_ComboWrappers(void)
{
	//Step 0
	...
	dMissingPiMinusWrapper = dStep0Wrapper->Get_FinalParticle(3);
...
#endif // DSelector_omega_misspim_h
