...
MyDataOutDir=/sciclone/gluex10/$USER/sim_analyzed/$MyProcess/2018-01_ver03/
...
MyRun=${MyRun:29:5} # get run number from filename (in this case 18 characters from the beginning of the filename: tree_pi0kpkm__B3_030496.root)
