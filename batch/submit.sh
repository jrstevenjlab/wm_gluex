...
for MyRun in 10007 10107 10207; do
##### 10007 = compton signal
##### 10107 = gp -> pi0p signal (PARA)
##### 10207 = gp -> pi0p signal (PERP)
...
mkdir -p log/$MyProcess/

MyProcessDir=$HOME/$MyProcess/
MyLogDir=`pwd`/log/

echo $MyProcessDir
echo $MyLogDir

qsub -l nodes=1:c10:ppn=$PPN -l walltime=00:60:00 -d $MyProcessDir/selector/ -o $MyLogDir/$MyProcess/$MyRun.out -e $MyLogDir/$MyProcess/$MyRun.err `pwd`/runDSelector.csh -v MyRun=$MyRun
